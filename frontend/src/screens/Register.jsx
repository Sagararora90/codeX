    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50">
            <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md border border-slate-200">
                ...
                >
                    <div className="mb-4">
                        <label className="block text-slate-600 mb-2 font-medium" htmlFor="username">Username</label>
                        <input
                ...
                <p className="text-slate-500 mt-6 text-center text-sm">
                    Already have an account? <Link to="/login" className="text-blue-600 hover:text-blue-700 font-medium hover:underline">Login</Link>
                </p>
            </div>
        </div>
    )
